...
function Footer() {
  ...
  return (
    <footer className="bg-linear-to-b from-gray-900 to-gray-950 text-white py-12 px-4 border-t border-red-500/20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-2xl font-bold mb-3">
              <span className="text-red-500">S</span>ufiyan <span className="text-red-500">A</span>zmat
            </h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              Creating beautiful and functional web experiences with modern technologies.
            </p>
            {/* Decorative line */}
            <div className="w-12 h-1 bg-red-500/50 mt-4"></div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#projects" className="text-gray-400 hover:text-red-500 transition-colors text-sm flex items-center gap-2 group">
                  <span className="w-1 h-1 bg-red-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Projects
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['React.js', 'Tailwind CSS', 'JavaScript', 'HTML5 & CSS3'].map((tech, index) => (
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              {/* <li>
                ...
                >
                  <svg className="w-4 h-4 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.104c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 0021.604-4.326 13.82 13.82 0 001.24-5.201c0-.21-.005-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                  </svg>
                  Twitter
                </a>
              </li> */}
              <li>
                <a 
                  href="mailto:sufiyanazmat05@gmail.com" 
                  className="text-gray-400 hover:text-red-500 transition-colors text-sm flex items-center gap-2 group"
                >
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center">
            <span className="bg-linear-to-b from-gray-900 to-gray-950 px-4 text-red-500">
              ✦
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm">
          <p className="text-gray-400">
            © {currentYear} <span className="text-red-500 font-semibold">Sufiyan Azmat</span>. All rights reserved.
          </p>
          <div className="flex items-center gap-4 mt-4 md:mt-0">
            <a href="#hero" className="text-gray-500 hover:text-red-500 transition-colors text-xs">Privacy</a>
            <span className="text-gray-700">•</span>
            <a href="#hero" className="text-gray-500 hover:text-red-500 transition-colors text-xs">Terms</a>
            <span className="text-gray-700">•</span>
        ...
        <div className="text-center mt-6">
          <a 
            href="#" 
            className="inline-flex items-center justify-center w-10 h-10 bg-gray-800 rounded-full hover:bg-red-600 transition-all duration-300 group"
          >
